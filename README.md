...
If you don't need any video features, you could use `amazon-chime-sdk-media-no-video-codecs` instead of `amazon-chime-sdk-media` and treat all references to `amazon-chime-sdk-media` as `amazon-chime-sdk-media-no-video-codecs` in the instructions below.
