...
### Added
* Supports integration of personal information identification/redaction and partial stability with Amazon Transcribe and Amazon Transcribe Medical for live transcription. The PII feature identifies/redacts personal information such as credit card info, addresses, SSN, etc. from live transcription, highlighted in green text. For more information, visit [Transcribe API Data Model Update](https://quip-amazon.com/2Ib7Aoas2iaM/reInvent-Transcribe-API-Data-Model-Update).
